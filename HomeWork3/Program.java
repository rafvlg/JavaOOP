...
public class Program {
    ...
    static Employee generateEmployee() {
        ...
        if (type == 0) {
            ...
            return new Freelancer(names[random.nextInt(names.length)], surnames[random.nextInt(3)], hoursWorked, hourlyRate);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < employees.length; i++){
            employees[i] = generateEmployee();
            employees[i].setAge(random.nextInt(20, 60)); // установим случайный возраст
        }
